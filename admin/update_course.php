...
include '../config/config.php';
	...
	if (isset($_POST['update'])) 
	{
		...
		if ($file) 
		{
			$query="UPDATE courses SET name='$name',description='$about', image='$dst_db' WHERE id='$id' ";
		}

		else
		{
			$query="UPDATE courses SET name='$name',description='$about' WHERE id='$id' ";
		}
